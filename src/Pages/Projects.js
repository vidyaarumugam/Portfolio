...
const Projects = () => {
    return (
        <>
            <div id="projects" className="text-color bg-backgroundOne w-full h-fit md:h-screen lg:h-screen flex flex-col justify-center items-center">
                <div className="text-headingColor font-bold font-sans text-3xl flex">
                    PROJECTS
                </div>
                <div className='flex flex-col md:flex-row lg:flex-row'>
                    <div className='m-3 lg:m-10 bg-backgroundTwo w-64 md:w-80 lg:w-96 rounded-lg'>
                        <img src={Portfolio} alt='Portfolio' className='h-52 lg:h-64' />
                        <div className='p-5 font-bold text-base lg:text-lg h-24 md:h-20 lg:h-20'>Academic Project Information Management System</div>
                        <p className='px-5 text-colorHeaderFooter h-40 md:h-36 lg:h-24'>
                    ...
                    <div className='m-3 lg:m-10 bg-backgroundTwo w-64 md:w-80 lg:w-96 rounded-lg'>
                        <img src={Macron} alt='Food' className='h-52 lg:h-64' />
                        <div className='p-5 font-bold text-base lg:text-lg h-24 md:h-20 lg:h-20'>Online Food Order</div>
                        <p className='px-5 text-colorHeaderFooter h-40 md:h-36 lg:h-24'>
