...
const About = () => {
    return (<div id="about" className="bg-backgroundTwo w-full h-fit md:h-screen lg:h-screen text-color flex justify-center items-center p-10">
        <div className="m-2 md:m-3 lg:m-10 lg:w-fit">
            <div className="text-headingColor font-bold font-sans text-3xl flex mb-10">
                ABOUT ME
            </div>
            <div className="flex flex-row">
                <div className="leading-7 tracking-wide text-sm md:text-base lg:text-lg">
        ...
        <div className="m-2 md:m-3 lg:m-5 flex justify-center items-center">
            <img alt="Laptop" src={Photo} className="w-6/6 lg:w-4/6" />
        </div>
    </div>
    )
}
